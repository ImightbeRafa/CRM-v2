...
# Client-visible Meta / app public IDs (build-time). Passed via wrangler containers.image_vars.
ARG NEXT_PUBLIC_FB_LOGIN_CONFIG_ID=
ARG NEXT_PUBLIC_IG_LOGIN_CONFIG_ID=
ARG NEXT_PUBLIC_META_APP_ID=
ARG NEXT_PUBLIC_META_WA_APP_ID=
ARG NEXT_PUBLIC_META_GRAPH_API_VERSION=v24.0
ARG NEXT_PUBLIC_APP_URL=
ARG NEXT_PUBLIC_TILOPAY_API_KEY=
ENV NEXT_PUBLIC_FB_LOGIN_CONFIG_ID=$NEXT_PUBLIC_FB_LOGIN_CONFIG_ID
ENV NEXT_PUBLIC_IG_LOGIN_CONFIG_ID=$NEXT_PUBLIC_IG_LOGIN_CONFIG_ID
ENV NEXT_PUBLIC_META_APP_ID=$NEXT_PUBLIC_META_APP_ID
ENV NEXT_PUBLIC_META_WA_APP_ID=$NEXT_PUBLIC_META_WA_APP_ID
