...
- Prove (post-#66 rebase onto `8dd8aa9`): `npx tsx --test src/lib/__tests__/chat-inbox-backfill-repair.test.ts`
  (8 pass) + `npm run test:chat-harden` (243 pass; 234 post-#65 plus #66 shortcut-import).
