...
- Prove (post-#65 rebase onto `630dd99`): `npx tsx --test src/lib/__tests__/chat-inbox-backfill-repair.test.ts`
  (8 pass) + `npm run test:chat-harden` (234 pass; same as post-#64, #65 docs-only).
