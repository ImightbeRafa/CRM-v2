...
- Rebased onto `dev` after #63 (`8f689b6` verify-betsy skill; parent
  ...
  written.
- Prove (post-#62 rebase onto `938f7bc`): `npx tsx --test src/lib/__tests__/chat-inbox-backfill-repair.test.ts`
  (8 pass) + `npm run test:chat-harden` (209 pass; same as post-#61).
