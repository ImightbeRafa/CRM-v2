...
- Prove (post-#67 rebase onto `63be5e7`): `npx tsx --test src/lib/__tests__/chat-inbox-backfill-repair.test.ts`
  (8 pass) + `npm run test:chat-harden` (243 pass; same as post-#66, #67 docs-only).
