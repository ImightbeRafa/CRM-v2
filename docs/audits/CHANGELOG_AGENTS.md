...
- Prove (post-#69 rebase onto `4bcce82`): `npx tsx --test src/lib/__tests__/chat-inbox-backfill-repair.test.ts`
  (8 pass) + `npm run test:chat-harden` (250 pass; was 243 post-#68, #69 added Soft agent tests).
