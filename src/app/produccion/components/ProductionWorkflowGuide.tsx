        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
              <h4 className="font-semibold text-green-800 mb-2">Órdenes de Envío (EA)</h4>
              <p className="text-sm text-green-700">Productos que se envían a los clientes</p>
            </div>
            <div className="p-3 bg-purple-50 border border-purple-200 rounded-lg">
              <h4 className="font-semibold text-purple-800 mb-2">Órdenes de Retiro (RA)</h4>
              <p className="text-sm text-purple-700">Productos que los clientes recogen</p>
            </div>
          </div>
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="flex items-center gap-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
              ...
              <div>
                <div className="font-semibold text-yellow-800">Pendiente</div>
                <div className="text-sm text-yellow-700">Orden recibida, esperando procesamiento</div>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <Package className="h-5 w-5 text-blue-600" />
              <div>
                <div className="font-semibold text-blue-800">En Proceso</div>
                <div className="text-sm text-blue-700">Orden siendo preparada</div>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-green-50 border border-green-200 rounded-lg">
              <CheckCircle className="h-5 w-5 text-green-600" />
              <div>
                <div className="font-semibold text-green-800">Completado</div>
                <div className="text-sm text-green-700">Orden lista para envío/retiro</div>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-purple-50 border border-purple-200 rounded-lg">
              <Truck className="h-5 w-5 text-purple-600" />
              <div>
                <div className="font-semibold text-purple-800">Enviado</div>
                <div className="text-sm text-purple-700">Orden en camino al cliente</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-gray-50 border rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-2">Usa la barra de búsqueda para encontrar órdenes por:</p>
            ...
            <div className="p-4 bg-gray-50 border rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-2">Selecciona un estado para ver solo esas órdenes:</p>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Pendiente</li>
                <li>• En Proceso</li>
                <li>• Completado</li>
            ...
            <div className="p-4 bg-gray-50 border rounded-lg">
              ...
              <p className="text-sm text-gray-600">Haz clic en &quot;Ver Detalles&quot; para:</p>
              <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="p-4 bg-gray-50 border rounded-lg">
              ...
              <p className="text-sm text-gray-600">Cambia el estado directamente desde la tarjeta:</p>
              <ul className="text-sm text-gray-600 space-y-1">
      ...
      content: (
        <div className="space-y-4">
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <h4 className="font-semibold text-blue-800 mb-2">📋 Seleccionar Múltiples Órdenes</h4>
          ...
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <h4 className="font-semibold text-green-800 mb-2">💡 Casos de Uso Comunes</h4>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-gray-50 border rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-2">Haz clic en &quot;Exportar&quot; para:</p>
              <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="p-4 bg-gray-50 border rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-2">Para órdenes de envío:</p>
              <ul className="text-sm text-gray-600 space-y-1">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <h4 className="font-semibold text-yellow-800 mb-2">⚡ Eficiencia</h4>
            ...
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <h4 className="font-semibold text-green-800 mb-2">📱 Móvil</h4>
              <ul className="text-sm text-green-700 space-y-1">
            ...
            <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
              <h4 className="font-semibold text-purple-800 mb-2">🛡️ Seguridad</h4>
