...
const baseOrderSchema = {
  ...
  product: z.string().optional().describe('REQUERIDO si no usas products: producto unico o resumen de productos. Si el mensaje dice "Producto(s):", copia esas lineas aqui. Para varios SKUs, no llames create_order varias veces: usa products con una linea por SKU.'),
  products: z.array(orderProductSchema).optional().describe('REQUERIDO si no usas product: lista de productos de UNA SOLA orden. Usa esto cuando el pedido tenga varios productos o varios SKUs.'),
